...
// Singleton class for connecting to firebase database full of data from bratislava
// Bratislava has to be in separated class because "object" singleton can not take an argument
object BratislavaFirebaseConnection : FirebaseConnectionInterface {
    private val TAG = this::class.java.simpleName

    private val database = FirebaseDatabase.getInstance()
    private val myRef = database.getReference("spots-ba")
